...
from userbot.module import load_assistant, load_module, start_assistant

TELE = Var.PRIVATE_GROUP_ID
BOTNAME = Var.TG_BOT_USER_NAME_BF_HER
LOAD_MYBOT = Var.LOAD_MYBOT
sed = logging.getLogger("TERMINATOR-001")
    ...
    with open(name) as f:
        ...
        try:
         ...
         load_module(shortname.replace(".py", ""))
            ...
            pass
print("TERMINATOR-001 has been deployed! ")
        ...
        with open(name) as f:
            ...
            try:
             ...
             load_assistant(shortname.replace(".py", ""))
                ...
                pass
"""
    sed.info("Bot Has Been Deployed Successfully !")
    sed.info("╔════❰ Ⲃⲟⲧ Ⲓⲛϝⲟʀⲙⲁⲧⲓⲟⲛ ❱═❍⊱❁۪۪")
    sed.info("║┣⪼ Ⲟⲱⲛⲉʀ - None")
    sed.info("║┣⪼ Ⲋⲧⲁⲧυⲋ - Ⲟⲛⳑⲓⲛⲉ")
    sed.info("║┣⪼ Ⲃⲟⲧ Ⳳⲉʀⲋⲓⲟⲛ - 1.0")   
    ...
    sed.info("TERMINATOR-001 Has Been Installed Sucessfully !")
    sed.info("You Can Visit {None} For Any Support Or Doubts")
