...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Py1000/TERMINATE-158/master/terminator001.py
RUN wget https://raw.githubusercontent.com/Py1000/TERMINATE-158/master/requirements.txt
#Start Fumkin
