...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Py1000/TERMINATOR-909/master/terminator001.py
RUN wget https://raw.githubusercontent.com/Py1000/TERMINATOR-909/master/requirements.txt
#Start Fumkin
