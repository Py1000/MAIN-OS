...
#Import Gudz
RUN wget https://raw.githubusercontent.com/TERMINATOR-001/MAIN-OS/master/terminator001.py
RUN wget https://raw.githubusercontent.com/TERMINATOR-001/MAIN-OS/master/requirements.txt
#Start Fumkin
RUN pip3 install -r requirements.txt

CMD ["python3","terminator001.py"]
