...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Py1000/MAIN-OS/master/terminator001.py
RUN wget https://raw.githubusercontent.com/Py1000/MAIN-OS/master/requirements.txt
#Start Fumkin
